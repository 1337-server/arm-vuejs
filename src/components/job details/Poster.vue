<template>
  <tr>
    ...
    <td style="text-align:left"><a v-bind:href="jobs.poster_url"><img
        alt="Poster image"
  ...
  <tr>
    ...
    <td style="text-align:left"><a v-bind:href="jobs.poster_url_auto"><img
        alt="Poster image"
  ...
  <tr>
    ...
    <td style="text-align:left"><a v-bind:href="jobs.poster_url_manual"><img
        alt="Poster image"
